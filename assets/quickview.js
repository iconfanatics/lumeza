...
function quickView() {
  $(".quick-view").click(function (e) {
    ...
    $.ajax({
      ...
      $(newDiv).find(".linked-products").remove();
      $(newDiv).find(".stacked-single-media-container").remove();
      // The sticky Add to Cart bar is fixed to the page and must not appear in Quick View.
      $(newDiv).find(".product-sticky-add-bar").remove();
